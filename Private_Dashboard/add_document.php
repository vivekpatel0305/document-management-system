...
<tbody>
    ...
    <tr>
      ...
      <td><?php echo $download; ?></td>
           ...
           <td><a href='downloads.php?file_id=<?php echo $id; ?>'  class="btn btn-sm btn-outline-primary"><i class="fa fa-download"></i></a> <a href='delete.php?ID=<?php echo $id; ?>'  class="btn btn-sm btn-outline-danger"><i class="fa fa-trash"></i></a><a href='preview.php?file_id=<?php echo $id; ?>'  class="btn btn-sm btn-outline-primary">preview<i class="fa fa-preview"></i></a>
    </tr>
<?php } ?>
</tbody>
   </table>
    ...
    <div class="footer-copyright py-3">
     <p>All right Reserved &copy; <?php echo date('Y');?> Created By:Web wizards</p>
    </div>
    <!--/.Copyright-->
