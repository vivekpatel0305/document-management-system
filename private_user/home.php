...
<div class="tab-content pt-2 pl-1" id="pills-tabContent">
  <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
    ...
    <div class="">
     ...
     <div class=""><p><b style="font-size: 1.1em">Team Name:</b>Web Wizards</p></div>
     <div class=""><p><b style="font-size: 1.1em">Position:</b>React devs</p></div>
  ...
  <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab"><h6 style="font-size: 1.1em">Contact Number</h6><Hr><br><div class=""><p><b style="font-size: 1.1em">Cellphone :</b>+919998021038</p></div><p><b style="font-size: 1.1em">Address :</b>Gandhinagar</p>
</div><hr><br>
<!--   <div class="card">
